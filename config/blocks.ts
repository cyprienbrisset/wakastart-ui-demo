...
export const blocks: BlockDefinition[] = [
  ...
  },
  {
    ...
    description: "Gestion des incidents avec timeline, répondants et escalade.",
    category: "DevOps",
    features: [
      "Liste des incidents par sévérité",
  ...
  },
  {
    ...
    description: "Carte de l'infrastructure cloud avec ressources et statuts.",
    category: "DevOps",
    features: [
      "Vue arbre des ressources",
      "Vue grille des ressources",
      "Filtrage par provider/région/type",
  ...
  },
  {
    name: "CICDBuilder",
    slug: "cicd-builder",
    description: "Constructeur de pipelines CI/CD visuel.",
    category: "DevOps",
    features: [
      "Éditeur visuel de stages",
  ...
  },
  {
    name: "ReleaseNotes",
    slug: "release-notes",
    description: "Gestion des notes de version avec changelog.",
    category: "DevOps",
    features: [
      "Liste des releases",
      "Types de changements (feature, fix, breaking)",
      "Contributeurs",
  ...
  {
    name: "OnCallScheduleBlock",
    slug: "on-call-schedule",
    description: "Planification des astreintes avec rotations.",
    category: "DevOps",
    features: [
      "Calendrier des astreintes",
      "Types de rotation (daily, weekly)",
  ...
  {
    name: "CloudCostDashboard",
    slug: "cloud-cost-dashboard",
    description: "Dashboard des coûts cloud avec analyse et alertes.",
    category: "DevOps",
    features: [
      "Coûts par provider/service/région",
  ...
  {
    name: "GitOpsSyncStatus",
    slug: "gitops-sync-status",
    description: "Statut de synchronisation GitOps (ArgoCD/Flux style).",
    category: "DevOps",
    features: [
  ...
  },
  {
    name: "APMOverview",
    slug: "apm-overview",
    description: "Vue d'ensemble APM avec services et transactions.",
    category: "DevOps",
    features: [
      "Liste des services",
      "Métriques clés (latency, throughput, errors)",
  ...
  },
  {
    ...
    description: "Orchestration de conteneurs avec services et scaling.",
    category: "DevOps",
    features: [
      "Liste des services",
      "Conteneurs par service",
      "Scaling horizontal",
      "Métriques CPU/mémoire",
      "Logs conteneurs",
      "Actions (restart, stop, remove)",
    ],
  },
  {
    name: "DatabaseAdmin",
    slug: "database-admin",
    description: "Administration de base de données avec métriques et backups.",
    category: "DevOps",
    features: [
